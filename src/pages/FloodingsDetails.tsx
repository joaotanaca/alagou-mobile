...
export default function FloodingsDetails() {
  ...
  const handleOpenGoogleMapsRoutes = () => {
    Linking.openURL(`http://maps.google.com/maps?saddr=${Floodings.latitude},${Floodings.longitude}`);
  }
    ...
    <ScrollView style={styles.container}>
      <View style={styles.detailsContainer}>
        ...
        <Text style={styles.title}>Instruções para visita</Text>
            <Text style={styles.description}>{Floodings.instructions}</Text>

        <View style={styles.scheduleContainer}>
          <View style={[styles.scheduleItem, styles.scheduleItemBlue]}>
            <Feather name='clock' size={40} color='#2AB5D1' />
            <Text style={[styles.scheduleText, styles.scheduleTextBlue]}>Segunda à Sexta {Floodings.opening_hours}</Text>
          </View>

          {Floodings.open_on_weekends ? (
